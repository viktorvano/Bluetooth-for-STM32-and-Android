...
package com.example.android.haptic_stimulator;
...
public class DeviceControlActivity extends Activity {
    ...
    private int seekBarValue = 0, lastValue = 0;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        textView.setText("value:" + seekBarValue);
        ...
        final Runnable r = new Runnable() {
            public void run() {
                if(seekBarValue != lastValue)
                {
                    lastValue = seekBarValue;
                    mBluetoothLeService.writeCharacteristic("value:" + seekBarValue + "\n");
                }
